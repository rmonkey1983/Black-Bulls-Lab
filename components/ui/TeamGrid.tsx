      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
        {teamMembers.map((member) => {
          ...
          return (
            ...
            >
              {/* Image Container */}
              <div className="relative aspect-4/5 overflow-hidden rounded-xl border border-white/10 bg-zinc-900 transition duration-500">
                {isJulian ? (
                  /* Julian Silhouette */
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-zinc-900 overflow-hidden group-hover:bg-zinc-800 transition-colors duration-500">
                    <div className="w-24 h-24 rounded-full border border-yellow-500/10 flex items-center justify-center mb-4 group-hover:border-yellow-500/30 transition duration-500">
              ...
              {/* Content */}
              <div className="mt-8 space-y-4 flex flex-col grow">
                ...
                <div className="h-px w-8 bg-yellow-500/30 group-hover:w-full transition duration-500" />

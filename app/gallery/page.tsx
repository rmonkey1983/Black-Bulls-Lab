        ...
        <main className="min-h-screen pb-24 bg-black relative">
            ...
            <div className="max-w-7xl mx-auto px-6 -mt-12 md:-mt-24 relative z-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="group relative aspect-14/16 overflow-hidden rounded-2xl border border-white/10">
                        <Image 
                            ...
                            fill
                            className="object-cover grayscale hover:grayscale-0 transition duration-1000 scale-105 group-hover:scale-100"
                        />
                ...
                <div className="mt-16 text-center">
                    <Link
                        href="/format"
                        className="inline-flex items-center justify-center gap-3 bg-rama-accent text-black font-heading font-bold uppercase tracking-widest text-sm px-8 py-4 rounded-xl hover:bg-white transition transform active:scale-95 shadow-lg"
                    >
                        Scopri i format
                        <ArrowRight size={16} />
                    </Link>

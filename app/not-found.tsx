    ...
    <main className="min-h-screen bg-black flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-10 max-w-2xl">
        ...
        <div className="relative select-none" aria-hidden="true">
          <span className="font-heading font-bold text-[10rem] md:text-[14rem] leading-none tracking-tighter text-white/4 block glitch-text">
            404
          </span>
        </div>
        ...
        <div className="space-y-4 -mt-16 relative z-10">
          <h1 className="font-heading font-bold text-3xl md:text-5xl lg:text-6xl uppercase tracking-tighter text-white">
        ...
        <div className="pt-4">
          <Link
            href="/"
            className="group inline-flex items-center gap-3 bg-rama-accent text-black font-heading font-bold uppercase tracking-[0.2em] text-xs px-10 py-5 rounded-full hover:bg-white hover:scale-105 transition duration-300 shadow-[0_0_30px_rgba(229,182,12,0.25)]"
          >
            Torna al Lab
            <ArrowRight
              size={14}

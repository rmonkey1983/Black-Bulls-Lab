    ...
    return (
        ...
        >
            ...
            <div className="absolute top-12 left-12 opacity-5 hidden md:block">
                <div className="font-mohave text-[10px] tracking-[0.4em] uppercase">
            ...
            <div className={clsx(
                ...
                <h2 className="font-mohave font-bold leading-[0.85] tracking-tighter uppercase text-white text-[10vw] sm:text-[8vw] md:text-[6vw] mb-8">
                ...
                <p className="font-outfit text-gray-500 text-lg md:text-xl max-w-2xl mb-12 leading-relaxed">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-6">
                    <PremiumButton href="/events" variant="gold" size="lg" className="w-full sm:w-auto px-12 py-5 rounded-sm">
                        <span className="font-mohave tracking-[0.2em] uppercase text-lg">Entra nel Laboratorio</span>
                    </PremiumButton>
                </div>
            </div>
        </section>

...
export function RamaHero() {
    return (
        <section className="relative w-full min-h-screen flex flex-col justify-center px-6 md:px-12 pt-32 pb-16 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full relative z-10 w-full">

                {/* Left Content */}
                <div className="flex flex-col items-start justify-center h-full pt-12 lg:pt-0 z-20 mix-blend-difference">
                    <RamaAnimatedText
                    ...
                    <div className="font-mohave font-bold leading-[0.8] tracking-tighter uppercase text-white flex flex-col text-[16vw] lg:text-[10vw]">
                        <RamaAnimatedText text="BENVENUTO AL" delay={0.1} className="text-[12vw] lg:text-[7.5vw] text-rama-accent" />
                        <RamaAnimatedText text="BLACK BULLS" delay={0.2} />
                        <RamaAnimatedText text="LAB." delay={0.3} />
                    </div>

                    <div className="mt-12 md:mt-16 text-rama-muted font-outfit text-lg md:text-xl lg:text-2xl max-w-xl">
                        <RamaAnimatedText
                    ...
                    <div className="mt-10 opacity-0 animate-[fadeIn_1s_ease-out_0.8s_forwards]">
                        <PremiumButton href="/events" variant="gold" size="lg">
                            <span className="font-mohave tracking-widest uppercase text-lg">Scopri gli Eventi e Prenota</span>
                            <ArrowRight size={20} className="ml-2" />
                        </PremiumButton>
                    </div>
                </div>

                {/* Right Content - Abstract Image / 3D Element */}
                <div className="relative h-full min-h-[50vh] flex items-center justify-center opacity-80 z-0">
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150%] h-[150%] max-w-[800px] pointer-events-none">
                        {/* Placeholder for 3D/Hero Graphic */}

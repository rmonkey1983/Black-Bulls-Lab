...
export function RamaHero() {
    ...
    const fallbackFormats = [
        ...
        { id: '3', title: 'Cena Con Il Delitto', image: '/images/brand/bg-venue-crowd.png', slug: 'cena-con-il-delitto' },
    ];
    ...
    return (
        <section className="relative w-full min-h-screen flex flex-col justify-center px-4 sm:px-6 md:px-12 pt-32 sm:pt-36 md:pt-28 pb-12 sm:pb-16 overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center h-full relative z-10 w-full">
                ...
                {/* Left Content */}
                <div id="hero-content" className="flex flex-col items-start justify-center h-full pt-8 lg:pt-0 z-20 mix-blend-difference overflow-hidden">
                    <RamaAnimatedText
                    ...
                    <div className="font-mohave font-bold leading-[0.85] tracking-tighter uppercase text-white flex flex-col text-[13vw] sm:text-[13vw] md:text-[12vw] lg:text-[10vw] w-full overflow-hidden">
                        ...
                        <span className="line"><span className="text-rama-accent">DI EMOZIONI.</span></span>
                        <span className="line"><span className="text-[9.5vw] sm:text-[9vw] md:text-[8.5vw] lg:text-[7.5vw] text-white/50">BLACK BULLS LAB</span></span>
                    </div>
                    ...
                    <div className="mt-6 sm:mt-10 md:mt-16 text-rama-muted font-outfit text-base sm:text-lg md:text-xl lg:text-2xl max-w-xl">
                        <p className="gsap-fade">
                            La tua serata a Torino che nessuno dimenticherà. Dinner show, cena con delitto e format immersivi — dal vivo, a partire da 50€.
                        </p>
                    </div>
                    ...
                    <div className="mt-8 sm:mt-10 opacity-0 animate-[fadeIn_1s_ease-out_0.8s_forwards]">
                        ...
                        >
                            <span className="font-mohave tracking-widest uppercase text-base sm:text-lg">Vedi le prossime date</span>

        ...
        <section className="relative w-full h-[100dvh] flex flex-col items-center justify-center px-4 sm:px-6 md:px-12 overflow-hidden text-center bg-black">
            ...
            <div id="hero-content" className="flex flex-col items-center justify-center max-w-5xl mx-auto h-full relative z-20 overflow-hidden py-24">
                    <RamaAnimatedText
                        ...
                        className="font-rock-salt text-rama-accent text-sm sm:text-xl md:text-3xl lg:text-4xl mb-6 transform -rotate-3 drop-shadow-[0_0_15px_rgba(200,164,78,0.5)]"
                    />

                    <h1 className="font-mohave font-bold uppercase tracking-[0.2em] text-[10px] sm:text-xs md:text-sm text-rama-accent/80 border border-rama-accent/30 px-6 py-2 rounded-full mb-8 backdrop-blur-md shadow-[0_0_30px_rgba(200,164,78,0.1)] leading-tight bg-white/5">
                        L&apos;INTRATTENIMENTO E&apos; DIVENTATO SCIENZA
                    </h1>

                    <div className="font-mohave font-bold leading-[0.82] tracking-tighter uppercase text-white flex flex-col items-center text-[18vw] sm:text-[15vw] md:text-[12vw] lg:text-[10vw] w-full">
                        ...
                        <span className="line">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-rama-accent via-white to-rama-accent">DI EMOZIONI.</span>
                        </span>
                    </div>

                    <div className="mt-10 sm:mt-12 md:mt-14 text-gray-400 font-outfit text-base sm:text-lg md:text-xl lg:text-2xl max-w-2xl px-4">
                    ...
                    <div className="mt-12 sm:mt-16 w-full sm:w-auto opacity-0 animate-[fadeIn_1s_ease-out_1s_forwards]">
                        ...
                        >
                            <span className="font-mohave tracking-widest uppercase text-lg">Entra nel laboratorio →</span>
                        </PremiumButton>
                    </div>
                </div>
                ...
                <div className="absolute bottom-8 right-8 z-30 opacity-20 hidden md:block">
                    <div className="text-right font-mohave text-[10px] tracking-[0.3em] uppercase space-y-1">

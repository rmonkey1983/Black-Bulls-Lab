        ...
        >
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto">
                ...
                <div className="text-center mb-12 sm:mb-16">
                    ...
                    />
                    <h2 className="font-mohave font-bold uppercase tracking-tighter text-white text-[12vw] sm:text-[9vw] md:text-[6vw] leading-[0.88] overflow-hidden">

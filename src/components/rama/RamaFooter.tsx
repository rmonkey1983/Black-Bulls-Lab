            ...
            <div className="max-w-7xl w-full flex flex-col md:flex-row justify-between items-center gap-12">
                ...
                <div className="flex flex-col items-center gap-6">
                    <div className="flex items-center gap-8">
                        <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/5 flex items-center justify-center text-zinc-400 hover:text-yellow-500 hover:border-yellow-500/50 transition-all duration-300" aria-label="Seguici su Instagram">
                            <Instagram size={18} />
                        </a>
                    </div>
                    <div className="flex flex-col md:flex-row gap-6 md:gap-10 font-heading text-[10px] uppercase tracking-[0.2em] text-zinc-400 font-bold">

...
export function ImmersiveHeader({
    ...
    return (
        <section id={id} className="pt-28 md:pt-40 lg:pt-60 px-4 sm:px-6 md:px-12 mb-16 md:mb-32 relative overflow-hidden min-h-[55vh] md:min-h-[80vh] flex flex-col justify-end pb-8 md:pb-24">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[10vw] md:text-[25vw] font-heading font-black text-white/5 whitespace-nowrap z-[1] tracking-tighter pointer-events-none uppercase mix-blend-difference max-w-full overflow-hidden">
            ...
            <div className={`relative z-10 w-full overflow-hidden ${align === "center" ? "flex flex-col items-center text-center" : ""}`}>
                ...
                {subtitle && (
                    <div id={`${id}-subtitle`} className="mt-8 md:mt-12 text-rama-muted font-sans text-base md:text-xl lg:text-2xl max-w-2xl text-left border-l-2 border-rama-accent/30 pl-6 bg-black/10 backdrop-blur-sm py-4 rounded-r-xl">

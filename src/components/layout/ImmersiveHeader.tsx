...
export function ImmersiveHeader({
    ...
    return (
        <section className="pt-40 md:pt-64 px-6 md:px-12 mb-24 md:mb-32 relative overflow-hidden">
            ...
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[25vw] font-outfit font-black text-white/5 whitespace-nowrap z-[-1] tracking-tighter pointer-events-none uppercase mix-blend-difference">
                {title.split(" ")[0]}
            </div>

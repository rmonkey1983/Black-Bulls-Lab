...
export function WhatsAppWidget() {
    ...
    return (
        <a
            ...
            className="fixed bottom-24 right-5 md:bottom-10 md:right-10 z-110 group flex flex-row-reverse items-center gap-3"
        >
            {/* Tooltip label */}
            <span className="hidden md:flex items-center opacity-0 group-hover:opacity-100 transition duration-300 -translate-x-2 group-hover:translate-x-0 bg-[#0a0a0a] border border-white/10 text-white font-sans text-sm px-4 py-2 rounded-full whitespace-nowrap shadow-xl">

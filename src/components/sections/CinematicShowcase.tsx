...
export function CinematicShowcase() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative min-h-screen bg-black-pure flex items-center overflow-hidden border-y border-white/5"
    >
      {/* Ambient lighting */}
      ...
      <div className="max-w-360 mx-auto px-6 md:px-12 py-32 md:py-40 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10 w-full">

        {/* ── LEFT: Editorial content ── */}
        <div className="showcase-content space-y-12">

          {/* Badge */}
          <div className="inline-flex items-center gap-3 px-5 py-2.5 border border-accent-gold/20 bg-accent-gold/4 backdrop-blur-sm">
        ...
        <div className="relative">
          ...
          <div className="showcase-parallax-image relative aspect-3/4 overflow-hidden border border-white/6">
            <Image
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black-pure/70 via-transparent to-black-pure/10" />
            {/* Film grain */}
            <div className="absolute inset-0 opacity-[0.03] bg-[url('/noise.webp')] mix-blend-overlay" />
          </div>

          {/* Floating UI — Status card */}
          <div className="floating-ui absolute top-4 right-4 md:-top-8 md:-right-8 w-48 md:w-56 p-5 bg-black-elevated/90 backdrop-blur-2xl border border-white/8 shadow-[0_40px_80px_rgba(0,0,0,0.9)]">
          ...
          <div className="floating-ui absolute bottom-4 left-4 md:-bottom-8 md:-left-8 w-48 md:w-64 p-6 bg-black-elevated/90 backdrop-blur-2xl border border-white/8 shadow-[0_40px_80px_rgba(0,0,0,0.9)]">

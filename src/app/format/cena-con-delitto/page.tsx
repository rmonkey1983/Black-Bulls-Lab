    ...
    return (
        <main ref={containerRef} className="min-h-screen">
            ...
            <section className="relative aspect-video md:h-[85vh] w-full overflow-hidden flex items-end">
                ...
                <div className="relative z-20 w-full max-w-7xl mx-auto p-6 md:p-12 mb-12">
                    <div id="delitto-hero" className="flex flex-col space-y-6">
                        ...
                        <p className="delitto-desc text-xl md:text-3xl text-gray-300 font-light max-w-2xl border-l-4 border-rama-accent pl-6 italic">
                            Un omicidio. Una cena. Un solo colpevole — se riesci a trovarlo.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <FormatQuickInfo 
                ...
                capacity="15 - 40 persone"
                price="Da 50€/persona"
                highlight="Dinner Show & Investigation"
            />
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 id="how-it-works-title" className="gsap-fade text-4xl md:text-5xl font-bold text-rama-text mb-4">
                            L&apos;INVESTIGAZIONE IN <span className="text-rama-accent italic">3 STEP</span>
                        </h2>
                        ...
                        {[
                            {
                                ...
                                title: "Step 1 — Il Crimine",
                                desc: "La serata inizia con un fatto: qualcuno è stato ucciso. Gli attori infiltrati al tavolo presentano i personaggi. Il gioco ha inizio."
                            },
                            {
                                icon: <Search size={24} />,
                                title: "Step 2 — L'Indagine",
                            ...
                            {
                                icon: <div className="text-2xl font-rock-salt">!</div>,
                                title: "Step 3 — Il Verdetto",
                                desc: "Prima del dessert ogni ospite consegna il suo verdetto scritto. Chi ha individuato il colpevole — e il movente corretto — vince il titolo di Miglior Investigatore."
                            }
                        ].map((step, i) => (
                            <div
                                key={i}

...
import { Instagram, ArrowLeft, Search } from "lucide-react";
                    ...
                    <div className="md:col-span-1 space-y-8">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-4 mt-6">
                                <a href={`https://instagram.com/${talent.name.toLowerCase().replace(/\s+/g, '')}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-rama-accent hover:border-rama-accent/30 transition duration-300">
                                    <Instagram size={20} />
                                </a>
                                <a href={`https://google.com/search?q=${encodeURIComponent(talent.name)}`} target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-white/10 flex items-center justify-center text-zinc-400 hover:text-rama-accent hover:border-rama-accent/30 transition duration-300">
                                    <Search size={20} />
                                </a>
                            </div>
                        </div>

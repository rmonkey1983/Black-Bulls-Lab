...
export default function CheckoutForm() {
    ...
    const event = {
        id: "1",
        title: eventId === "il-palqo" ? "Il Palqo" : "Notte Medievale: Il Banchetto del Toro",
        price: 85,
    ...
    const calendarDates = useMemo(() => {
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            // Simulate sold out: random days are sold out, e.g. divisble by 5
        ...
        <div className="min-h-screen bg-transparent pt-24 pb-32 px-4 sm:px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    {/* Left: Form Area */}
                    <div className="lg:col-span-8 bg-white/[0.02] border border-white/10 rounded-2xl p-6 sm:p-10 shadow-2xl relative overflow-hidden backdrop-blur-sm">
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                        <div className="flex justify-between items-center mb-6">
                                            <h3 className="text-lg font-bold text-white flex items-center gap-2">
                                                <Calendar size={18} className="text-gold" /> Data dell&apos;Evento
                                            </h3>
                                            <div className="flex items-center gap-4 text-white">
                                                <button onClick={handlePrevMonth} className="hover:text-gold transition-colors"><ChevronLeft size={20} /></button>
                                                <span className="font-bold uppercase tracking-widest text-sm text-gold">
                                            ...
                                            {calendarDates.map((item, idx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        {isSoldOut && <span className="text-[9px] uppercase tracking-tighter opacity-80 leading-none">Sold Out</span>}
                                                    </button>
                                                );
                                            })}
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2 relative">
                                            ...
                                            <div className="relative">
                                                ...
                                                {isEmailValid && <CheckCircle className="absolute right-4 top-1/2 -translate-y-1/2 text-green-500 w-5 h-5" />}
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-2 relative">
                                            ...
                                            <div className="relative">
                                                ...
                                                {isPhoneValid && <CheckCircle className="absolute right-4 top-1/2 -translate-y-1/2 text-green-500 w-5 h-5" />}
                                            </div>
                            ...
                            {step === 3 && (
                                <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8">
                                    ...
                                    <div className="space-y-6 bg-white/5 border border-white/10 rounded-xl p-6">
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Allergie o Intolleranze</label>
                                            <textarea 
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-xs font-bold uppercase tracking-widest text-gray-400">Occasione Speciale</label>
                                            <select 
                        ...
                        <div className="bg-bg-dark/50 border border-white/10 rounded-2xl p-6 sticky top-32">
                            ...
                            <div className="space-y-5 text-sm">
                                <div className="space-y-1">
                                    <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">L&apos;Esperienza</p>
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">Ospiti & Location</p>
                                ...
                                {step > 1 && guest.name && (
                                    <div className="space-y-1 border-t border-white/5 pt-4 mt-4 animate-[fadeIn_0.5s_ease-out]">
                                        <p className="text-xs uppercase tracking-widest text-gray-500 font-bold">Intestatario</p>

...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "esperienze immersive Torino", "eventi privati Torino", "format cena teatro Torino"
  ],
    ...
    <html lang="it" suppressHydrationWarning>
      ...
      >
        ...
        <FAQPageSchema faqs={[
          ...
          { question: "Posso organizzare un evento privato o aziendale a Torino?", answer: "Certamente. Black Bulls Lab organizza cene aziendali, team building, dinner show e eventi immersivi a Torino per gruppi di 20-30 persone. Contattaci a info@blackbullslab.it per un preventivo personalizzato." },
          ...
          { question: "Quanto costa partecipare a un dinner show di Black Bulls Lab?", answer: "I nostri format partono da 50€ a persona, con soluzioni flessibili per gruppi aziendali e privati. Il prezzo include la cena e lo spettacolo immersivo. Contattaci per un preventivo su misura per il tuo gruppo." },
        ]} />
      </body>
    </html>
  );

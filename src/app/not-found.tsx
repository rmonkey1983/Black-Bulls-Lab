    ...
    <main className="min-h-screen bg-black flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center space-y-8 max-w-2xl">
        ...
        <div className="space-y-4">
          <h1 className="font-mohave font-bold text-white text-8xl md:text-[12rem] leading-none tracking-tighter opacity-10">
            404
          </h1>
        ...
        <div className="pt-8">
          <Link
            href="/"
            className="group inline-flex items-center gap-3 bg-white text-black font-mohave font-bold uppercase tracking-widest text-sm px-10 py-5 rounded-full hover:bg-rama-accent transition-all transform active:scale-95"
          >
        ...
        <div className="pt-12">
            <p className="text-[10px] font-mohave text-white/20 uppercase tracking-[0.5em]">

                    ...
                    <StickyTextSection
                        ...
                        content={
                            <div className="space-y-6">
                                ...
                                <div className="bg-black/50 backdrop-blur-md p-6 md:p-8 rounded-2xl border border-white/5 shadow-2xl mt-8">
                                    <p className="text-base md:text-lg text-white/90 font-outfit font-light leading-relaxed">

...
const GALLERY_IMAGES = [
    { src: "/images/brand/vibe-live-jazz.webp", alt: "Atmosfera Live Jazz & Performance" },
    { src: "/images/brand/service-plating.webp", alt: "Arte del Plating - Esperienza Gourmet" },
    { src: "/images/brand/vibe-cocktail-art.webp", alt: "Cocktail Art & Mixology" },
    { src: "/images/brand/service-performance.webp", alt: "Live Performance a Torino" },
    { src: "/images/brand/bg-venue-crowd.webp", alt: "L'energia dei nostri eventi" },
    { src: "/images/brand/team-art-director.webp", alt: "Dietro le quinte: Luci e Regia" },
    { src: "/images/brand/team-mixologist.webp", alt: "La nostra area Bar & Spirits" },
    { src: "/images/brand/team-chef.webp", alt: "Creatività in Cucina" },
];
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-24 md:space-y-32">
                ...
                <section className="space-y-12">
                        ...
                        {GALLERY_IMAGES.map((img, i) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-4">
                                    <p className="text-white font-sans text-xs md:text-sm font-medium tracking-wide translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                        {img.alt}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="flex justify-center pt-8">
                        <p className="text-rama-muted font-sans text-sm italic flex items-center gap-2">
                ...
                <section className="py-16 md:py-24 flex flex-col items-center text-center space-y-10 border-t border-white/5 bg-gradient-to-b from-white/[0.02] to-transparent rounded-[2rem] px-6">
                    ...
                    <div className="space-y-5 max-w-3xl">
                        <h2 className="font-heading font-bold uppercase tracking-tighter text-white text-4xl md:text-7xl leading-none">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 w-full sm:w-auto">
                        <a 
                            ...
                            className="group inline-flex items-center justify-center gap-3 bg-rama-accent text-black font-heading font-bold uppercase tracking-widest text-base px-10 py-5 rounded-full hover:bg-white transition-all transform active:scale-95 shadow-xl shadow-rama-accent/10"
                        >
                ...
                <section className="py-16 md:py-24 border-t border-white/10 text-center space-y-8">
                    ...
                    <h2 className="font-heading font-bold uppercase tracking-tighter text-white text-5xl md:text-7xl leading-[0.9]">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                        <Link
                            href="/contact"
                            className="group inline-flex items-center justify-center gap-3 bg-white text-black font-heading font-bold uppercase tracking-widest text-base px-10 py-5 rounded-full hover:bg-rama-accent transition-all transform active:scale-95"
                        >
                        ...
                        <Link
                            href="/format"
                            className="inline-flex items-center justify-center border border-white/20 text-white font-heading font-bold uppercase tracking-widest text-base px-10 py-5 rounded-full hover:border-rama-accent/60 hover:text-rama-accent transition-all transform active:scale-95"

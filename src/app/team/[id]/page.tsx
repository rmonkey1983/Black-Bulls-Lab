  ...
  if (!member) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        <h1 className="font-heading text-4xl md:text-6xl text-white uppercase font-bold mb-6">Artista non trovato</h1>
        <p className="font-sans text-rama-muted mb-12 max-w-md">L'ID richiesto non corrisponde a nessun membro del nostro team attuale.</p>
        <PrimaryButton href="/chi-siamo" size="lg">
          Torna alla lista
        </PrimaryButton>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="profile-content mb-12">
          <Link 
            ...
            className="group inline-flex items-center gap-2 text-rama-muted hover:text-white transition-colors duration-300 font-sans uppercase tracking-widest text-xs"
          >
